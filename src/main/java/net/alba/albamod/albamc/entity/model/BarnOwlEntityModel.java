...
public class BarnOwlEntityModel extends EntityModel<BarnOwlEntityRenderState> {
    ...
    public BarnOwlEntityModel(ModelPart modelPart) {
        super(modelPart);
    ...
    public void setAngles(BarnOwlEntityRenderState parrotEntityRenderState) {
        super.setAngles(parrotEntityRenderState);
        this.animateModel(parrotEntityRenderState.barnOwlPose);
        ...
        switch (parrotEntityRenderState.barnOwlPose) {
            case STANDING:
    ...
    private void animateModel(BarnOwlEntityModel.Pose pose) {
        switch (pose) {
            case FLYING:
    ...
    public static BarnOwlEntityModel.Pose getPose(BarnOwlEntity parrot) {
        if (parrot.isSongPlaying()) {
            return BarnOwlEntityModel.Pose.PARTY;
        } else if (parrot.isInSittingPose()) {
            return BarnOwlEntityModel.Pose.SITTING;
        } else {
            return parrot.isInAir() ? BarnOwlEntityModel.Pose.FLYING : BarnOwlEntityModel.Pose.STANDING;
        }
    }
